...
export default function SetPasswordPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (notFound) {
    return (
      <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#080310] text-gray-100 px-4">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <Link
            href="/signin"
            className="inline-block rounded-lg bg-primary px-6 py-2.5 text-sm font-semibold text-white hover:opacity-90 transition"
          >
            Go to Sign In
          </Link>
        </div>
    ...
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#080310] text-gray-100 bg-dot-pattern px-4 py-10">
      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center gap-6 animate-slide-up">
        ...
        <div className="w-full rounded-2xl border border-white/10 bg-[#12091d]/80 p-8 shadow-2xl backdrop-blur-xl">
          ...
          <p className="text-xs text-gray-500 mb-6">Account: <span className="text-primary">{prospect.email}</span></p>
