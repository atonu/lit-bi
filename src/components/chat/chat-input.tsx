...
const DEFAULT_SUGGESTIONS = [
  ...
  "Compare monthly sales vs expenses over time",
  "Show me a months vs sales comparison diagram in area chart",
  "Compare department budgets with their total operational expenses",
  "Show total sales generated by each Associate or Senior Associate with bar chart",
  "Show the breakdown of expenses by category in pie chart",
  "Show a scatter chart of employees salaries",
...
export function ChatInput({
  ...
  const suggestions = isTestUser
    ? DEFAULT_SUGGESTIONS
    : [...userTemplates, ...DEFAULT_SUGGESTIONS.slice(0, Math.max(0, 6 - userTemplates.length))];
        ...
        <div className="flex items-center justify-end">
          <div className="relative">
            <button
              ...
              className="flex items-center gap-1.5 rounded-full border border-white/10 bg-white/[0.04] px-2.5 py-1 text-xs text-white/40 transition-all hover:border-white/20 hover:text-white/70"
            >
                ...
                <div className="absolute bottom-full right-0 z-20 mb-2 min-w-[200px] overflow-hidden rounded-2xl border border-white/10 bg-[#1e1e1e] shadow-2xl shadow-black/60">
                  {AVAILABLE_MODELS.map((m) => (
                    <button
                      ...
                      className={cn(
                        "flex w-full items-center gap-2.5 px-4 py-2.5 text-left text-xs transition-colors hover:bg-white/[0.06]",
